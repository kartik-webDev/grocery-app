    ...
    <div className="relative">
      ...
      <div className="absolute inset-0 flex flex-col items-center md:items-start justify-end 
        ...
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center md:text-left
          ...
          Freshness That Delights, Savings That Excite!
        </h1>
      ...
      <div className='flex items-center mt-6 font-medium'>
        ...
        <Link to={"/products"} className='group flex items-center gap-2 px-7 md:px-9 py-3 bg-blue-500 hover:bg-blue-500-dull transition rounded text-white cursor-pointer'>
          Shop Now
